"""
Test script for DocOrient and geometry pipeline on real cards.
"""
...
def run():
    ...
    for side, path in samples:
        ...
        print(f"  DocOrient on raw warped: angle={res_raw.angle}, method={res_raw.method}, reliable={res_raw.reliable}")
        print(f"  DocOrient on Cand 0°:   angle={res_0.angle}, method={res_0.method}, reliable={res_0.reliable}")
        print(f"  DocOrient on Cand 180°: angle={res_180.angle}, method={res_180.method}, reliable={res_180.reliable}")
